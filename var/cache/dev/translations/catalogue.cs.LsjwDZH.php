...
$catalogue = new MessageCatalogue('cs', array (
  ...
  array (
    ...
    'search.page_title' => '{0} Žádné položky nebyly nalezeny|{1} <strong>1</strong> položka nalezena|{2,3,4} <strong>%count%</strong> položky nalezeny|[5,Inf] <strong>%count%</strong> položek nalezeno',
